...
h.inverseTangent = h.atan = function () {
  ...
  for (
    l.precision = u = a + 10, l.rounding = 1, i = Math.min(28, (u / m + 2) | 0), e = i;
    e;
    --e
  )
...
h.minus = h.sub = function (e) {
  ...
  for (
    a && ((n = f), (f = d), (d = n), (e.s = -e.s)), o = f.length, t = d.length - o;
    t > 0;
    --t
  )
    f[o++] = 0;
...
h.plus = h.add = function (e) {
  ...
  for (
    o = f.length, r = l.length, o - r < 0 && ((r = o), (i = l), (l = f), (f = i)), n = 0;
    r;
...
function B(e, n) {
  ...
  for (
    a = N, c = o = N = k(N.minus(1), N.plus(1), l, 1), d = p(N.times(N), l, 1), r = 3;
    ;
