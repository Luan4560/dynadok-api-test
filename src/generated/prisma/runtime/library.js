  ...
  'FORCE_COLOR' in Q &&
    (Q.FORCE_COLOR === 'true'
      ...
      : Q.FORCE_COLOR === 'false'
        ? (Ge = 0)
        : (Ge =
            Q.FORCE_COLOR.length === 0 ? 1 : Math.min(parseInt(Q.FORCE_COLOR, 10), 3)));
  function gi(e) {
...
`,
  ...
  function cp(e) {
    ...
    let t = B._parseVault(e),
      n = process.env;
    return (
      e && e.processEnv != null && (n = e.processEnv), B.populate(n, t, e), { parsed: t }
    );
  }
  function pp(e) {
...
var po = (e, r = new co()) => {
    ...
    return (
      e.getConnectionInfo && (t.getConnectionInfo = nf(r, e.getConnectionInfo.bind(e))), t
    );
  },
  tf = (e, r) => ({
