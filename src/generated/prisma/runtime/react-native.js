...
var Pi = Ae(rt => {
  ...
  T.prototype.writeUint8 = T.prototype.writeUInt8 = function (e, t, r) {
    return (
      (e = +e), (t = t >>> 0), r || ie(this, e, t, 1, 255, 0), (this[t] = e & 255), t + 1
    );
  };
...
S.inverseTangent = S.atan = function () {
  ...
  for (
    g.precision = a = h + 10, g.rounding = 1, r = Math.min(28, (a / F + 2) | 0), e = r;
    e;
    --e
  )
...
S.plus = S.add = function (e) {
  ...
  for (
    s = u.length, i = g.length, s - i < 0 && ((i = s), (r = g), (g = u), (u = r)), t = 0;
    i;
...
function De(e, t) {
  ...
  for (
    h = A, l = s = A = j(A.minus(1), A.plus(1), g, 1), v = O(A.times(A), g, 1), i = 3;
    ;
...
var Wn = (e, t = new Jn()) => {
    ...
    return (
      e.getConnectionInfo && (r.getConnectionInfo = kp(t, e.getConnectionInfo.bind(e))), r
    );
  },
  Rp = (e, t) => ({
