...
function yn(t, e) {
  ...
  for (
    a = f.length, o = h.length, a - o < 0 && ((o = a), (n = h), (h = f), (f = n)), r = 0;
    o;
...
function bn(t, e) {
  ...
  for (
    T && ((r = f), (f = C), (C = r), (e.s = -e.s)), a = f.length, i = C.length - a;
    i > 0;
    --i
  )
    f[a++] = 0;
      ...
      return function (n, i, o, s) {
        ...
        if (((H = (H / N + 2) | 0), (h = 0), se == 1))
          ...
          for (
            T = (Q / (U[0] + 1)) | 0,
              T > 1 &&
                ((U = t(U, T)), (ue = t(ue, T)), (se = U.length), (Se = ue.length)),
              z = se,
              S = ue.slice(0, se),
              M = S.length;
            M < se;
...
function ia(t, e) {
  ...
  r &&
    (r.getField(t.firstField)?.markAsError(), r.getField(t.secondField)?.markAsError()),
    e.addErrorMessage(
      n =>
...
function ft({ green: t, enabled: e }) {
  return (
    'Available options are ' + (e ? `listed in ${t('green')}` : 'marked with ?') + '.'
  );
}
function Jt(t, e) {
...
var en = (t, e = new Zr()) => {
    ...
    return (
      t.getConnectionInfo && (r.getConnectionInfo = bl(e, t.getConnectionInfo.bind(t))), r
    );
  },
  hl = (t, e) => ({
