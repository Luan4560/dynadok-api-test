...
var Ci = Fe(Ke => {
  ...
  T.prototype.writeUint8 = T.prototype.writeUInt8 = function (e, t, r) {
    return (
      (e = +e), (t = t >>> 0), r || te(this, e, t, 1, 255, 0), (this[t] = e & 255), t + 1
    );
  };
...
var za = {
  enabled: !ki && Ii == null && Oi !== 'dumb' && ((yn != null && yn !== '0') || Di),
};
function j(e, t) {
...
C.inverseTangent = C.atan = function () {
  ...
  for (
    g.precision = a = h + 10, g.rounding = 1, r = Math.min(28, (a / O + 2) | 0), e = r;
    e;
    --e
  )
...
C.minus = C.sub = function (e) {
  ...
  for (
    h && ((t = d), (d = v), (v = t), (e.s = -e.s)), s = d.length, n = v.length - s;
    n > 0;
    --n
  )
    d[s++] = 0;
...
C.plus = C.add = function (e) {
  ...
  for (
    s = d.length, i = g.length, s - i < 0 && ((i = s), (r = g), (g = d), (d = r)), t = 0;
    i;
...
function ke(e, t) {
  ...
  for (
    h = R, l = s = R = q(R.minus(1), R.plus(1), g, 1), v = I(R.times(R), g, 1), i = 3;
    ;
